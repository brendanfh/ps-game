...
(function(exports) {
  ...
  var initialize = function __do() {
      ...
      $foreign.onKeyDown(function (key) {
          return Control_Monad_Eff_Ref.modifyRef(v)(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ key ]));
      })();
      $foreign.onKeyUp(function (key) {
          return Control_Monad_Eff_Ref.modifyRef(v)(Data_Array.filter(Data_Eq.notEq(Data_Eq.eqInt)(key)));
      })();
      return v;
  };
...
(function(exports) {
  ...
  var Control_Monad_Eff_Ref = PS["Control.Monad.Eff.Ref"];
  var Prelude = PS["Prelude"];        
  var initialTouchSystem = {
      touches: [  ]
  };
  var initialize = function __do() {
      var v = Control_Monad_Eff_Ref.newRef(initialTouchSystem)();
      $foreign.setupTouch(v)();
      return v;
  };
  exports["initialTouchSystem"] = initialTouchSystem;
  exports["initialize"] = initialize;
})(PS["Util.Touch"] = PS["Util.Touch"] || {});
(function(exports) {
  // Generated by purs version 0.11.1
  ...
  var view = function (ctx) {
      return function (stateRef) {
          return function __do() {
              var v = Control_Monad_Eff_Ref.readRef(stateRef)();
              return view$prime(ctx)(v.status)(stateRef)();
          };
      };
  };
  exports["view"] = view;
...
(function(exports) {
  ...
  var initial = function __do() {
      ...
      var v1 = Util_Touch.initialize();
      var v2 = GameMap.generateMap(10)(10)();
      return {
          num: 0.0, 
  ...
  var main = function __do() {
      ...
      return __unused()((function () {
          ...
          throw new Error("Failed pattern match at Main line 27, column 5 - line 29, column 5: " + [ v.constructor.name ]);
      })())();
  };
