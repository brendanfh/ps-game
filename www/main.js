...
(function(exports) {
  ...
  var gameStatusEq = new Data_Eq.Eq(function (x) {
      return function (y) {
          if (x instanceof Playing && y instanceof Playing) {
              return true;
          };
          if (x instanceof MainMenu && y instanceof MainMenu) {
              return true;
          };
          return false;
      };
  ...
  exports["gameStatusEq"] = gameStatusEq;
})(PS["Types"] = PS["Types"] || {});
(function(exports) {
    "use strict";
...
(function(exports) {
  ...
  var view = function (state) {
      return function (ctx) {
          if (Data_Eq.eq(Types.gameStatusEq)(state.status)(Types.Playing.value)) {
              return function __do() {
                  ...
                  var v3 = Graphics_Canvas.fillRect(ctx)({
                      x: Util_Math.sin(state.num) * 100.0 + 100.0, 
                      y: 0.0, 
                      w: 100.0, 
                      h: 100.0
                  })();
          ...
          throw new Error("Failed pattern match at Main line 35, column 1 - line 44, column 18: " + [ state.constructor.name, ctx.constructor.name ]);
      };
  };
  var update = function (time) {
      return function (state) {
          if (Data_Eq.eq(Types.gameStatusEq)(state.status)(Types.Playing.value)) {
              return function __do() {
                  var v = Control_Bind.ifM(Control_Monad_Eff.bindEff)(Util_Keyboard.isDown(state.keyboard)(32))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(Optic_Setter.set(Lenses.num(Data_Identity.functorIdentity))(0.0)(state)))(Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(state))();
                  return Optic_Setter.add(Data_Semiring.semiringNumber)(Lenses.num(Data_Identity.functorIdentity))(time)(v);
              };
          };
          if (Data_Boolean.otherwise) {
              return Control_Applicative.pure(Control_Monad_Eff.applicativeEff)(state);
          };
          throw new Error("Failed pattern match at Main line 23, column 1 - line 32, column 19: " + [ time.constructor.name, state.constructor.name ]);
      };
  };
  ...
  var main = function __do() {
      ...
      return __unused()((function () {
          ...
          throw new Error("Failed pattern match at Main line 48, column 5 - line 49, column 5: " + [ v.constructor.name ]);
      })())();
  };
